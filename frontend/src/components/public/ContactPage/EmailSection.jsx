  ...
  return (
    <div className="text-center pb-10">
                    ...
                    <div className="flex justify-center space-x-4">
                        <div className="bg-blue-800 text-white p-6 rounded-lg shadow-lg w-80">
                        ...
                        <div className="bg-white text-blue-800 p-6 rounded-lg shadow-lg w-80 border border-gray-200">
                            <div className="text-4xl mb-4">
