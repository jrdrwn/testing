        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col items-center md:flex-row md:items-start md:justify-between">
            <div className="flex flex-col items-center md:items-start mb-8 md:mb-0 w-full md:w-1/4 mr-16">
              ...
              <p className="text-gray-600 mt-4">Empowering your practical skills and career guidance with community!</p>
            ...
            {/* Section untuk Links */}
            <div className="flex flex-wrap justify-between w-full md:w-3/4 space-y-6 md:space-y-0">
